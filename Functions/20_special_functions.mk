...
$(let var rest,$(mylist),$(var) $(let var rest,$(rest),$(var) )))
# Spaces in list are not preserved
$(info -§1c- Spaces in list are not preserved =\
$(let v1 v2 v3 v4 v5 v6,   111 222 333    444 555 666   ,$(v1) $(v2) $(v3) $(v4) $(v5) $(v6)))
# Type of variables - simple expanded
$(info -§1d- Type of variables is simple expanded)
...
$(info -§3a- $(foreach var,  111 222     333 $(comma) $(space) 444 $(multiline) 555 #66 \#666 7:7 8;8 9*9 a$$a b%b c\c d\\d e(@)e f{f g}g h[h i]i jüj kæk l"l m'm,'$(var)'))
...
$(info -§3b- $(foreach var,$(special_cars),'$(var)'))

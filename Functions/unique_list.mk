...
export list1 ::= $(call prepare_list_for_sort,$(list1))
$(info uniq  = '$(call uniq,list1)')

$(info list1a = '$(list1a)')
export list1a ::= $(call prepare_list_for_sort,$(list1a))
$(info uniq   = '$(call uniq,list1a)')

$(info list2 = '$(list2)')
export list2 ::= $(call prepare_list_for_sort,$(list2))
$(info $(value list2))
$(info uniq  = '$(call uniq,list2)')

$(info list3 = '$(list3)')
export list3 ::= $(call prepare_list_for_sort,$(list3))
$(info uniq  = '$(call uniq,list3)')

$(info list4 = '$(list4)')
export list4 ::= $(call prepare_list_for_sort,$(list4))
$(info uniq  = '$(call uniq,list4)')

$(info list5 = '$(list5)')
export list5 ::= $(call prepare_list_for_sort,$(list5))
$(info uniq  = '$(call uniq,list5)')

$(info list6 = '$(list6)')
export list6 ::= $(call prepare_list_for_sort,$(list6))
$(info uniq  = '$(call uniq,list6)')

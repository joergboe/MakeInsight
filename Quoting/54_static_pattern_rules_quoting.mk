...
# Target List: % must be quoted with \
# Target and source pattern: % must be quoted with \

# Usage:   make -f 54_static_pattern_rules_quoting.mk
# Cleanup: make -f 54_static_pattern_rules_quoting.mk clean

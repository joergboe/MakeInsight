...
# Escaping rule for %
# % in stem
# \% in target and prerequisite - after stem

# Target List: % must be quoted with \ and 2N backslashes
# Target and source pattern: unquoted \%

# Usage:   make -f 53_static_pattern_rules_quoting.mk
# Cleanup: make -f 53_static_pattern_rules_quoting.mk clean

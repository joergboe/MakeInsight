...
# Escaping rule for %
# % in stem
# \% in target and prerequisite - before stem

# Target List: \% must be quoted with \ and 2N backslashes
# Target and source pattern: % must be quoted with \ and 2N backslashes

# Usage:   make -f 55_static_pattern_rules_quoting.mk
# Cleanup: make -f 55_static_pattern_rules_quoting.mk clean
